    ...
    <div className="min-h-screen flex flex-col bg-red-200">
        ...
        <section className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
            <div className="flex flex-col justify-center">
                <h1 className="text-4xl font-semibold mb-4 text-red-500">Manadong</h1>
                <p className="text-lg mb-5 grid grid-cols-2">is a Manado dish with a spicy and appetizing flavour.</p>
                <p className="text-lg mb-10 mt-3 text-red-500 font-semibold">#NikmatnyaGaPakeRibet</p>
                <div className='grid grid-cols-2'>
                    <button className="text-blue-800 font-semibold py-2 px-4 rounded outline" onClick={handleOrderNowClick}>Order Now</button>
                </div>
            </div>
        ...
        <section className="flex justify-between p-10 items-center bg-red-100">
            <div className="flex-shrink-0">
                <p className="text-blue-800 font-semibold p-5">Promotion</p>
            </div>
            <div className="flex space-x-4">
                <div className="bg-white p-4 rounded-lg">
                    <img src={buy2} alt="Deal" className='w-[120px] h-[120px] mb-5'/>
                    <p className="text-blue-800 font-semibold">Buy 2 Get 1</p>
                ...
                <div className="bg-white p-4 rounded-lg">
                    ...
                    <p className="text-blue-800 font-semibold">Discount 20%</p>
                    <div className='w-[150px]'>
                ...
                <div className="bg-white p-4 rounded-lg">
                    ...
                    <p className="text-blue-800 font-semibold">Bundle Deal</p>
                    <div className='w-[150px]'>
        ...
        <section className="grid grid-cols-3 gap-4 p-10 items-center bg-white">
            <div className="col-span-3 font-semibold text-blue-800 p-5">
                Locations
            </div>
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Senopati, Petogogan</p>
                        ...
                        <div className="flex items-center mt-5 underline">
                            ...
                            <a href="" className="text-red-400 font-semibold">View Map</a>
                        </div>
                    </div>
                </div>
            </div>
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Kebun Jeruk / Tanjung Duren</p>
            ...
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Food Plaza PIK</p>
            ...
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Kuningan - D'Kanteen</p>
            ...
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Bintaro, Thelapan Square</p>
            ...
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Gading Serpong</p>
            ...
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Cipete</p>
            ...
            <div className="col-span-1">
                <div className="bg-white flex items-center p-4 shadow-lg">
                    ...
                    <div className="ml-4">
                        <p className="text-blue-800 font-semibold">Menteng</p>
